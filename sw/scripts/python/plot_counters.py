...
with open("./logs/counter_regs_80m_20m_dcoff_gnd_idac_16.txt", 'r') as file:
    for line in file:
...
# Plot for COUNTER_P
axs[0].plot(data_corrected["CNT_P"], "s-", label="COUNTER_P", color="blue")
...
# Plot for COUNTER_N
axs[1].plot(data_corrected["CNT_N"], "s-", label="COUNTER_N", color="green")
...
axs[2].plot(data_corrected["CNT_P_MINUS_N"], "s-", label="COUNTER_P - COUNTER_N", color="red")
