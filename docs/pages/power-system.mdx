...
<BasePathImage src="/images/power_system_diagram.png" alt="Power System Block Diagram" width="500px" />

SCuM-V24B has 3 power domains:
...
<BasePathImage src="/images/swcap_converter.png" alt="Switched Capacitor Converter Schematic" width="500px" />

Simulated Efficiency Variation with Load

**(Left) Efficiency Variation with Load. (Right) Vout Variation with Load:**
![Efficiency and Output Variation](/images/2023-08-18T16-16-56-451Z.png)
...
| Parameter | LDO_RF (1 V) | LDO_Digital (0.85 V) | LDO_Analog (1 V) |
|---|---|---|---|
...
#### Line regulation
<BasePathImage src="/images/3ldo_line_reg.png" alt="Line regulation" width="600px" />

#### Load regulation
<BasePathImage src="/images/3ldo_load_reg.png" alt="Load regulation" width="600px" />
...
**Parameters and simulated performance**
...
![Utility Current DAC Schematic](/images/2023-08-18T16-31-54-728Z.png)
