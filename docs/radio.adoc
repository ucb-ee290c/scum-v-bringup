...
__Designers__: Julian Maravilla (TX), Awani Khodkumbhe (LNA, mixer), Qiutong Jin (bandpass filter, VGA), Kevin Lu (ADC, RX integration)

__Authors__: Naz Khairallah (TX), Titan Yuan (TX), Kevin Lu (RX)

__Bringup__: Naz Khairallah (TX), Titan Yuan (TX)
