...
module Integrator_3(
  input  [15:0] io_window,	// @[generators/baseband/src/main/scala/modem/CDR.scala:48:14]
  output [5:0]  io_sum	// @[generators/baseband/src/main/scala/modem/CDR.scala:48:14]
);
  ...
  assign io_sum = {_io_sum_T_2[4], _io_sum_T_2} + {{5{~(io_window[4])}}, 1'h1} + {{5{~(io_window[5])}}, 1'h1} + {{5{~(io_window[6])}}, 1'h1} + {{5{~(io_window[7])}}, 1'h1} + {{5{~(io_window[8])}}, 1'h1} + {{5{~(io_window[9])}}, 1'h1} + {{5{~(io_window[10])}}, 1'h1} + {{5{~(io_window[11])}}, 1'h1} + {{5{~(io_window[12])}}, 1'h1} + {{5{~(io_window[13])}}, 1'h1} + {{5{~(io_window[14])}}, 1'h1} + {{5{~(io_window[15])}}, 1'h1};	// @[generators/baseband/src/main/scala/modem/CDR.scala:53:{50,60}, :54:27]
endmodule
