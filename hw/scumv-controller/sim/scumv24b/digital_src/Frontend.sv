...
module Frontend(
  input         clock,
                reset,
                auto_icache_master_out_a_ready,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
  output        auto_icache_master_out_a_valid,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
  output [31:0] auto_icache_master_out_a_bits_address,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
  input         auto_icache_master_out_d_valid,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
  input  [2:0]  auto_icache_master_out_d_bits_opcode,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
                auto_icache_master_out_d_bits_size,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
  input  [31:0] auto_icache_master_out_d_bits_data,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
  input         auto_icache_master_out_d_bits_corrupt,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
  ...
  input  [31:0] io_cpu_req_bits_pc,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:81:14]
  ...
  output [31:0] io_cpu_resp_bits_pc,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:81:14]
                io_cpu_resp_bits_data,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:81:14]
  ...
  input  [31:0] io_ptw_customCSRs_csrs_0_value	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:81:14]
);
  ...
  reg  [31:0] s1_pc;	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:111:18]
  reg         s1_speculative;	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:112:27]
  reg  [31:0] s2_pc;	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:113:22]
  ...
  wire [31:0] predicted_npc = {s1_pc[31:2], 2'h0} + 32'h4;	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:111:18, :124:20, :125:25]
  ...
  wire [31:0] io_cpu_npc = {io_cpu_req_valid ? io_cpu_req_bits_pc[31:1] : s2_replay ? s2_pc[31:1] : predicted_npc[31:1], 1'h0};	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18, generators/rocket-chip/src/main/scala/rocket/Frontend.scala:66:26, :81:14, :87:64, :101:19, :113:22, :125:25, :130:46, :131:16, :182:28, :377:33]
  ...
  always @(posedge clock) begin
    ...
    s1_pc <= io_cpu_npc;	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:111:18, :377:33]
    ...
    if (reset) begin
      s2_valid <= 1'h0;	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18, generators/rocket-chip/src/main/scala/rocket/Frontend.scala:66:26, :81:14, :87:64, :101:19, :104:25]
      s2_pc <= 32'h10000;	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18, generators/rocket-chip/src/main/scala/rocket/Frontend.scala:113:22, :377:27]
      s2_speculative <= 1'h0;	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18, generators/rocket-chip/src/main/scala/rocket/Frontend.scala:66:26, :81:14, :87:64, :101:19, :119:31]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_pc = {_RANDOM[3'h0][31:3], _RANDOM[3'h1][2:0]};	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:103:21, :111:18]
        s1_speculative = _RANDOM[3'h1][3];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:111:18, :112:27]
        s2_pc = {_RANDOM[3'h1][31:4], _RANDOM[3'h2][3:0]};	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:111:18, :113:22]
        s2_tlb_resp_pf_inst = _RANDOM[3'h5][24];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:117:24]
        s2_tlb_resp_ae_inst = _RANDOM[3'h5][30];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:117:24]
        s2_tlb_resp_cacheable = _RANDOM[3'h6][2];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:117:24]
        ...
        fq_io_enq_valid_REG = _RANDOM[3'h7][2];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:180:29]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  ICache icache (	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:66:26]
    ...
    .io_req_bits_addr               (io_cpu_npc),	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:377:33]
