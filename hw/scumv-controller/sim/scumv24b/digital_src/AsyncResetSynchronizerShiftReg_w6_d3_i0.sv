...
module AsyncResetSynchronizerShiftReg_w6_d3_i0(
  input        clock,
               reset,
  input  [5:0] io_d,	// @[generators/rocket-chip/src/main/scala/util/ShiftReg.scala:36:14]
  output [5:0] io_q	// @[generators/rocket-chip/src/main/scala/util/ShiftReg.scala:36:14]
);
  ...
  assign io_q = {_output_chain_5_io_q, _output_chain_4_io_q, _output_chain_3_io_q, _output_chain_2_io_q, _output_chain_1_io_q, _output_chain_io_q};	// @[generators/rocket-chip/src/main/scala/util/ShiftReg.scala:45:23, generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:90:14]
endmodule
