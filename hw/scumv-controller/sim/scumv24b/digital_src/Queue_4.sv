...
module Queue_4(
  ...
  input  [10:0] io_enq_bits_source,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  input  [29:0] io_enq_bits_address,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  input         io_enq_bits_mask,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
                io_enq_bits_corrupt,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  output [10:0] io_deq_bits_source,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  output [29:0] io_deq_bits_address,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  output        io_deq_bits_mask,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
                io_deq_bits_corrupt	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
);

  wire [51:0] _ram_ext_R0_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  ram_8x52 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_corrupt, io_enq_bits_mask, io_enq_bits_address, io_enq_bits_source, io_enq_bits_size, io_enq_bits_param, io_enq_bits_opcode})	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  );
  ...
  assign io_deq_bits_size = _ram_ext_R0_data[8:6];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_source = _ram_ext_R0_data[19:9];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_address = _ram_ext_R0_data[49:20];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_mask = _ram_ext_R0_data[50];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[51];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
endmodule
