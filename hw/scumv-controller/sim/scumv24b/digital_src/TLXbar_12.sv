...
module TLXbar_12(
  ...
  wire       requestDOI_0_0 = auto_out_d_bits_source == 2'h2;	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:46:9, generators/rocket-chip/src/main/scala/tilelink/Xbar.scala:348:24]
  wire       portsDIO_filtered_0_valid = auto_out_d_valid & requestDOI_0_0;	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:46:9, generators/rocket-chip/src/main/scala/tilelink/Xbar.scala:351:40]
  wire       portsDIO_filtered_1_valid = auto_out_d_valid & ~(auto_out_d_bits_source[1]);	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:54:{10,32}, generators/rocket-chip/src/main/scala/tilelink/Xbar.scala:351:40]
  reg  [3:0] beatsLeft;	// @[generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:60:30]
  wire       idle = beatsLeft == 4'h0;	// @[generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:60:30, :61:28, :84:44]
  ...
  always @(posedge clock) begin
    if (reset) begin
      beatsLeft <= 4'h0;	// @[generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:60:30, :84:44]
      ...
      if (latch)	// @[generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:62:24]
        ...
        beatsLeft <= beatsLeft - {3'h0, auto_out_a_ready & out_0_a_valid};	// @[generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:60:30, :85:52, :96:24, generators/rocket-chip/src/main/scala/tilelink/Bundles.scala:259:74, src/main/scala/chisel3/util/Decoupled.scala:52:35]
  ...
  TLMonitor_65 monitor_1 (	// @[generators/rocket-chip/src/main/scala/tilelink/Nodes.scala:24:25]
    .clock                (clock),
    .reset                (reset),
  ...
  assign auto_out_a_bits_opcode = (muxState_0 ? auto_in_0_a_bits_opcode : 3'h0) | {muxState_1, 2'h0};	// @[generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:89:25, generators/rocket-chip/src/main/scala/tilelink/Bundles.scala:259:74, src/main/scala/chisel3/util/Mux.scala:30:73]
  assign auto_out_a_bits_size = {1'h0, muxState_0 | muxState_1, 1'h0};	// @[generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:89:25, src/main/scala/chisel3/util/Mux.scala:30:73]
  assign auto_out_a_bits_source = {muxState_0, muxState_1};	// @[generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:89:25, src/main/scala/chisel3/util/Mux.scala:30:73]
  ...
  assign auto_out_a_bits_mask = (muxState_0 ? auto_in_0_a_bits_mask : 4'h0) | {4{muxState_1}};	// @[generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:84:44, :89:25, src/main/scala/chisel3/util/Mux.scala:30:73]
  ...
  assign auto_out_d_ready = requestDOI_0_0 | ~(auto_out_d_bits_source[1]);	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:46:9, :54:{10,32}, src/main/scala/chisel3/util/Mux.scala:30:73]
endmodule
