...
module AsyncQueueSource_28(
  ...
  input  [23:0] io_enq_bits,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:71:14]
  output [23:0] io_async_mem_0,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:71:14]
  ...
  reg  [23:0] mem_0;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [23:0] mem_1;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [23:0] mem_2;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [23:0] mem_3;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [23:0] mem_4;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [23:0] mem_5;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [23:0] mem_6;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [23:0] mem_7;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        mem_0 = _RANDOM[3'h0][23:0];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_1 = {_RANDOM[3'h0][31:24], _RANDOM[3'h1][15:0]};	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_2 = {_RANDOM[3'h1][31:16], _RANDOM[3'h2][7:0]};	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_3 = _RANDOM[3'h2][31:8];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_4 = _RANDOM[3'h3][23:0];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_5 = {_RANDOM[3'h3][31:24], _RANDOM[3'h4][15:0]};	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_6 = {_RANDOM[3'h4][31:16], _RANDOM[3'h5][7:0]};	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_7 = _RANDOM[3'h5][31:8];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        widx_widx_bin = _RANDOM[3'h6][3:0];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:52:25]
        ready_reg = _RANDOM[3'h6][4];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:52:25, :88:56]
        widx_gray = _RANDOM[3'h6][8:5];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:52:25, :91:55]
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        widx_widx_bin = 4'h0;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:52:25, :53:23]
        ready_reg = 1'h0;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16, :88:56]
