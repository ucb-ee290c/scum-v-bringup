...
module TLDebugModuleOuter(
  ...
  input  [6:0]  auto_dmi_in_a_bits_address,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
  input  [31:0] auto_dmi_in_a_bits_data,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
  input         auto_dmi_in_d_ready,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
  ...
  wire       io_innerCtrl_valid_0 = out_woready_12 | innerCtrlValidReg;	// @[generators/rocket-chip/src/main/scala/devices/debug/Debug.scala:625:36, :636:54, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:82:24]
  wire       io_innerCtrl_bits_resumereq_0 = out_woready_12 & auto_dmi_in_a_bits_data[30] | innerCtrlResumeReqReg;	// @[generators/rocket-chip/src/main/scala/devices/debug/Debug.scala:626:40, :638:{54,83}, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:82:24]
  wire       io_innerCtrl_bits_ackhavereset_0 = out_woready_12 & auto_dmi_in_a_bits_data[28] | innerCtrlAckHaveResetReg;	// @[generators/rocket-chip/src/main/scala/devices/debug/Debug.scala:627:43, :639:{57,89}, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:82:24]
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      innerCtrlValidReg <= io_innerCtrl_valid_0 & ~io_innerCtrl_ready;	// @[generators/rocket-chip/src/main/scala/devices/debug/Debug.scala:625:36, :632:{52,54}, :636:54]
      innerCtrlResumeReqReg <= io_innerCtrl_bits_resumereq_0 & ~io_innerCtrl_ready;	// @[generators/rocket-chip/src/main/scala/devices/debug/Debug.scala:626:40, :632:54, :633:61, :638:83]
      innerCtrlAckHaveResetReg <= io_innerCtrl_bits_ackhavereset_0 & ~io_innerCtrl_ready;	// @[generators/rocket-chip/src/main/scala/devices/debug/Debug.scala:627:43, :632:54, :634:64, :639:89]
    end
  ...
  assign io_innerCtrl_valid = io_innerCtrl_valid_0;	// @[generators/rocket-chip/src/main/scala/devices/debug/Debug.scala:636:54]
  assign io_innerCtrl_bits_resumereq = io_innerCtrl_bits_resumereq_0;	// @[generators/rocket-chip/src/main/scala/devices/debug/Debug.scala:638:83]
  ...
  assign io_innerCtrl_bits_ackhavereset = io_innerCtrl_bits_ackhavereset_0;	// @[generators/rocket-chip/src/main/scala/devices/debug/Debug.scala:639:89]
