...
module Queue_5(
  ...
  assign io_deq_bits_source = _ram_ext_R0_data[17:9];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_address = _ram_ext_R0_data[49:18];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
