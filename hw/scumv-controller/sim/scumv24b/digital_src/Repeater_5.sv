...
module Repeater_5(
  output        io_enq_ready,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:12:14]
  ...
  assign io_deq_bits_opcode = io_enq_bits_opcode;
  assign io_deq_bits_param = io_enq_bits_param;
  ...
  assign io_deq_bits_corrupt = io_enq_bits_corrupt;
endmodule
