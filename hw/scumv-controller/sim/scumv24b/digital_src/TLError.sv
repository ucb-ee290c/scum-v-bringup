...
module TLError(
  ...
  input  [127:0] auto_in_a_bits_address,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
  ...
  output         auto_in_d_bits_denied,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
                 auto_in_d_bits_corrupt	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
);
  ...
  wire            nodeIn_a_ready = da_ready & idle;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:26:23, :32:37, generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:94:31]
  ...
  `ifndef SYNTHESIS	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:31:12]
    always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:31:12]
      if (~reset & ~(idle | ~counter)) begin	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:26:23, :31:{12,18}, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27, :231:25]
  ...
  wire            _nodeIn_d_bits_WIRE_1 = _nodeIn_d_bits_WIRE_5 & da_bits_opcode[0];	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:35:21, generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:89:25, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:106:36, src/main/scala/chisel3/util/Mux.scala:30:73]
  wire [1:0]      _nodeIn_d_bits_WIRE_8 = {_nodeIn_d_bits_WIRE_5, 1'h0};	// @[generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:89:25, src/main/scala/chisel3/util/Mux.scala:30:73]
  wire [2:0]      _nodeIn_d_bits_WIRE_10 = _nodeIn_d_bits_WIRE_5 ? da_bits_opcode : 3'h0;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:35:21, generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:89:25, generators/rocket-chip/src/main/scala/tilelink/Bundles.scala:260:74, src/main/scala/chisel3/util/Mux.scala:30:73]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        counter = _RANDOM[/*Zero width*/ 1'b0][2];	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:26:23, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
  ...
  TLMonitor_50 monitor (	// @[generators/rocket-chip/src/main/scala/tilelink/Nodes.scala:24:25]
    .clock                (clock),
    .reset                (reset),
    .io_in_a_ready        (nodeIn_a_ready),	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:32:37]
  ...
  assign auto_in_a_ready = nodeIn_a_ready;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Error.scala:32:37]
  ...
  assign auto_in_d_bits_corrupt = _nodeIn_d_bits_WIRE_1;	// @[src/main/scala/chisel3/util/Mux.scala:30:73]
endmodule
