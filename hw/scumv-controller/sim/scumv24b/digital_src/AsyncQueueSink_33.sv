...
module AsyncQueueSink_33(
  ...
  wire [2:0]       _ridx_incremented_T = ridx_ridx_bin + {2'h0, io_deq_valid_0};	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:52:25, :53:43, :162:29]
  ...
  wire [3:0][24:0] _GEN = {{io_async_mem_3}, {io_async_mem_2}, {io_async_mem_1}, {io_async_mem_0}};	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:209:18]
  ...
  ClockCrossingReg_w25 io_deq_bits_deq_bits_reg (	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:207:25]
    .clock (clock),
    .io_d  (_GEN[_index_T ^ {ridx_incremented[2], 1'h0}]),	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:53:23, :54:17, :152:{55,75}, generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:209:18]
    .io_q  (io_deq_bits),
