...
module Queue_37(
  ...
  wire [78:0] _ram_ext_R0_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  ram_2x79 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
    ...
    .W0_clk  (clock),
    .W0_data ({1'h0, io_enq_bits_data, io_enq_bits_mask, io_enq_bits_address, 1'h0, io_enq_bits_size, 3'h0, io_enq_bits_opcode})	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95]
  );
  ...
  assign io_deq_bits_source = _ram_ext_R0_data[9];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_address = _ram_ext_R0_data[41:10];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_mask = _ram_ext_R0_data[45:42];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_data = _ram_ext_R0_data[77:46];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[78];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
endmodule
