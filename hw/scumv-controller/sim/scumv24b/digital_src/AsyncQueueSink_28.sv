...
module AsyncQueueSink_28(
  ...
  output [23:0] io_deq_bits,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:135:14]
  input  [23:0] io_async_mem_0,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:135:14]
  ...
  wire [3:0]       _ridx_incremented_T = ridx_ridx_bin + {3'h0, io_deq_ready & io_deq_valid_0};	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:52:25, :53:43, :162:29, src/main/scala/chisel3/util/Decoupled.scala:52:35]
  ...
  wire [7:0][23:0] _GEN = {{io_async_mem_7}, {io_async_mem_6}, {io_async_mem_5}, {io_async_mem_4}, {io_async_mem_3}, {io_async_mem_2}, {io_async_mem_1}, {io_async_mem_0}};	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:209:18]
  ...
  ClockCrossingReg_w24 io_deq_bits_deq_bits_reg (	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:207:25]
    .clock (clock),
