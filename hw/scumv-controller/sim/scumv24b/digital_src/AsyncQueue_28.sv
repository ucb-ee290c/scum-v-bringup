...
module AsyncQueue_28(
  ...
  input  [1:0] io_enq_bits,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:223:14]
  ...
  output [1:0] io_deq_bits	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:223:14]
);
  ...
  wire [1:0] _source_io_async_mem_0;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:224:70]
  wire [1:0] _source_io_async_mem_1;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:224:70]
  wire [1:0] _source_io_async_mem_2;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:224:70]
  wire [1:0] _source_io_async_mem_3;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:224:70]
  wire [1:0] _source_io_async_mem_4;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:224:70]
  wire [1:0] _source_io_async_mem_5;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:224:70]
  wire [1:0] _source_io_async_mem_6;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:224:70]
  wire [1:0] _source_io_async_mem_7;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:224:70]
  ...
  AsyncQueueSource_31 source (	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:224:70]
    .clock                        (io_enq_clock),
    .reset                        (io_enq_reset),
  ...
  AsyncQueueSink_31 sink (	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:225:70]
    .clock                        (io_deq_clock),
    .reset                        (io_deq_reset),
