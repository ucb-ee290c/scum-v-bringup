...
module Queue_32(
  ...
  reg  [31:0] ram;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  always @(posedge clock) begin
    if (do_enq)	// @[src/main/scala/chisel3/util/Decoupled.scala:52:35]
      ram <= io_enq_bits;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
    if (reset)
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram = {_RANDOM[1'h0][31:1], _RANDOM[1'h1][0]};	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
        full = _RANDOM[1'h0][0];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_deq_bits = ram;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
endmodule
