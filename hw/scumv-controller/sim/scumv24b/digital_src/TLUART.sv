...
module TLUART(
  ...
  output        auto_io_out_txd,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
  input         auto_io_out_rxd	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
);
  ...
  wire             _out_out_bits_data_WIRE_6 = auto_control_xing_in_a_bits_address[11:5] == 7'h0;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:192:34, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:70:19, :82:24, src/main/scala/chisel3/util/OneHot.scala:58:35]
  ...
  assign out_backSel_1 = auto_control_xing_in_a_bits_address[4:2] == 3'h1;	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:82:24, src/main/scala/chisel3/util/OneHot.scala:58:35]
  ...
  assign out_woready_2 = _out_wofireMux_T_2 & auto_control_xing_in_a_bits_address[4:2] == 3'h0 & _out_out_bits_data_WIRE_6;	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:82:24, src/main/scala/chisel3/util/OneHot.scala:58:35]
  wire             out_woready_11 = _out_wofireMux_T_2 & auto_control_xing_in_a_bits_address[4:2] == 3'h2 & _out_out_bits_data_WIRE_6;	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:82:24, src/main/scala/chisel3/util/OneHot.scala:58:35]
  wire             out_woready_13 = _out_wofireMux_T_2 & auto_control_xing_in_a_bits_address[4:2] == 3'h3 & _out_out_bits_data_WIRE_6;	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:82:24, src/main/scala/chisel3/util/OneHot.scala:58:35]
  wire             out_woready_15 = _out_wofireMux_T_2 & auto_control_xing_in_a_bits_address[4:2] == 3'h4 & _out_out_bits_data_WIRE_6;	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:69:36, :82:24]
  wire [7:0]       _GEN = {{1'h1}, {_out_out_bits_data_WIRE_6}, {_out_out_bits_data_WIRE_6}, {_out_out_bits_data_WIRE_6}, {_out_out_bits_data_WIRE_6}, {_out_out_bits_data_WIRE_6}, {_out_out_bits_data_WIRE_6}, {_out_out_bits_data_WIRE_6}};	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:82:24, generators/rocket-chip/src/main/scala/util/MuxLiteral.scala:49:10]
  wire [7:0][31:0] _GEN_0 = {{32'h0}, {{16'h0, div}}, {{30'h0, ip_rxwm, ip_txwm}}, {{30'h0, ie_rxwm, ie_txwm}}, {{7'h0, rxwm, 15'h0, rxen}}, {{7'h0, txwm, 14'h0, nstop, txen}}, {{~_rxq_io_deq_valid, 23'h0, _rxq_io_deq_bits}}, {{~_txq_io_enq_ready, 31'h0}}};	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UART.scala:130:19, :133:19, :135:20, :141:21, :142:21, :149:21, :150:21, :151:22, :186:19, :189:28, :190:28, generators/rocket-chip-blocks/src/main/scala/util/RegMapFIFO.scala:24:9, :45:21, generators/rocket-chip/src/main/scala/tilelink/Bundles.scala:259:74, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:82:24, generators/rocket-chip/src/main/scala/util/MuxLiteral.scala:49:{10,48}, src/main/scala/chisel3/util/OneHot.scala:58:35]
  ...
  wire [8:0]       _out_womask_T_13 = {auto_control_xing_in_a_bits_mask[3], {8{auto_control_xing_in_a_bits_mask[2]}}};	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:82:24]
  always @(posedge clock) begin
    if (reset) begin
      div <= 16'h6C8;	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UART.scala:135:20]
      ...
      if (_out_wofireMux_T_2 & auto_control_xing_in_a_bits_address[4:2] == 3'h6 & _out_out_bits_data_WIRE_6 & (&{{8{auto_control_xing_in_a_bits_mask[1]}}, {8{auto_control_xing_in_a_bits_mask[0]}}}))	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:82:24, src/main/scala/chisel3/util/OneHot.scala:58:35]
      ...
      if (out_woready_13 & auto_control_xing_in_a_bits_mask[0])	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:82:24]
        rxen <= auto_control_xing_in_a_bits_data[0];	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UART.scala:142:21, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:82:24]
      if (out_woready_11 & (&_out_womask_T_13))	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:82:24]
      ...
      if (out_woready_13 & (&_out_womask_T_13))	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:82:24]
        rxwm <= auto_control_xing_in_a_bits_data[24:16];	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UART.scala:150:21, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:82:24]
      if (out_woready_11 & auto_control_xing_in_a_bits_mask[0])	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:82:24]
  ...
  Queue_23 txq (	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UART.scala:130:19]
    .clock        (clock),
    .reset        (reset),
  ...
  Queue_23 rxq (	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UART.scala:133:19]
    .clock        (clock),
    .reset        (reset),
    .io_enq_ready (/* unused */),
    ...
    .io_deq_ready (_out_wofireMux_T & out_front_bits_read & out_backSel_1 & _out_out_bits_data_WIRE_6 & auto_control_xing_in_a_bits_mask[0]),	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:69:36, :82:24]
  ...
  assign auto_control_xing_in_d_bits_data = _GEN[auto_control_xing_in_a_bits_address[4:2]] ? _GEN_0[auto_control_xing_in_a_bits_address[4:2]] : 32'h0;	// @[generators/rocket-chip/src/main/scala/tilelink/Bundles.scala:259:74, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:82:24, generators/rocket-chip/src/main/scala/util/MuxLiteral.scala:49:10]
endmodule
