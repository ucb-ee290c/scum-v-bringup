...
module Repeater_12(
  ...
  input  [11:0] io_enq_bits_address,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:12:14]
  ...
  output [11:0] io_deq_bits_address,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:12:14]
  ...
  reg  [11:0] saved_address;	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:20:18]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        saved_address = {_RANDOM[2'h0][31:21], _RANDOM[2'h1][0]};	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:19:21, :20:18]
        saved_mask = _RANDOM[2'h1][4:1];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:20:18]
        saved_corrupt = _RANDOM[2'h2][5];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:20:18]
      `endif // RANDOMIZE_REG_INIT
    end // initial
