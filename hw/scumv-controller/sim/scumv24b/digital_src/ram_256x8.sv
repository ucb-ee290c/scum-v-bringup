...
module ram_256x8(	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  input  [7:0] R0_addr,
  input        R0_en,
               R0_clk,
  output [7:0] R0_data,
  ...
  reg [7:0] Memory[0:255];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
    ...
    initial begin	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
        for (logic [8:0] i = 9'h0; i < 9'h100; i += 9'h1) begin
          ...
          Memory[i[7:0]] = _RANDOM_MEM[7:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
