...
module AsyncQueueSource_37(
  input         clock,
                reset,
                io_enq_valid,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:71:14]
  input  [11:0] io_enq_bits,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:71:14]
  output [11:0] io_async_mem_0,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:71:14]
  ...
  reg  [11:0] mem_0;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [11:0] mem_1;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [11:0] mem_2;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [11:0] mem_3;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [11:0] mem_4;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [11:0] mem_5;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [11:0] mem_6;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [11:0] mem_7;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [11:0] mem_8;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [11:0] mem_9;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [11:0] mem_10;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [11:0] mem_11;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [11:0] mem_12;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [11:0] mem_13;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [11:0] mem_14;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [11:0] mem_15;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [11:0] mem_16;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [11:0] mem_17;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [11:0] mem_18;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [11:0] mem_19;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [11:0] mem_20;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [11:0] mem_21;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [11:0] mem_22;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [11:0] mem_23;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [11:0] mem_24;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [11:0] mem_25;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [11:0] mem_26;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [11:0] mem_27;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [11:0] mem_28;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [11:0] mem_29;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [11:0] mem_30;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  reg  [11:0] mem_31;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
  ...
  always @(posedge clock) begin
    if (_widx_T_1 & index == 5'h0)	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:52:25, :80:16, :85:64, :86:{22,35}, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      mem_0 <= io_enq_bits;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
    if (_widx_T_1 & index == 5'h1)	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16, :85:64, :86:{22,35}, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      mem_1 <= io_enq_bits;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
    if (_widx_T_1 & index == 5'h2)	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16, :85:64, :86:{22,35}, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      mem_2 <= io_enq_bits;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
    if (_widx_T_1 & index == 5'h3)	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16, :85:64, :86:{22,35}, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      mem_3 <= io_enq_bits;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
    if (_widx_T_1 & index == 5'h4)	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16, :85:64, :86:{22,35}, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      mem_4 <= io_enq_bits;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
    if (_widx_T_1 & index == 5'h5)	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16, :85:64, :86:{22,35}, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      mem_5 <= io_enq_bits;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
    if (_widx_T_1 & index == 5'h6)	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16, :85:64, :86:{22,35}, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      mem_6 <= io_enq_bits;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
    if (_widx_T_1 & index == 5'h7)	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16, :85:64, :86:{22,35}, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      mem_7 <= io_enq_bits;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
    if (_widx_T_1 & index == 5'h8)	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16, :85:64, :86:{22,35}, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      mem_8 <= io_enq_bits;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
    if (_widx_T_1 & index == 5'h9)	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16, :85:64, :86:{22,35}, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      mem_9 <= io_enq_bits;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
    if (_widx_T_1 & index == 5'hA)	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16, :85:64, :86:{22,35}, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      mem_10 <= io_enq_bits;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
    if (_widx_T_1 & index == 5'hB)	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16, :85:64, :86:{22,35}, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      mem_11 <= io_enq_bits;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
    if (_widx_T_1 & index == 5'hC)	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16, :85:64, :86:{22,35}, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      mem_12 <= io_enq_bits;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
    if (_widx_T_1 & index == 5'hD)	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16, :85:64, :86:{22,35}, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      mem_13 <= io_enq_bits;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
    if (_widx_T_1 & index == 5'hE)	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16, :85:64, :86:{22,35}, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      mem_14 <= io_enq_bits;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
    if (_widx_T_1 & index == 5'hF)	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16, :85:64, :86:{22,35}, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      mem_15 <= io_enq_bits;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
    if (_widx_T_1 & index == 5'h10)	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16, :85:64, :86:{22,35}, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      mem_16 <= io_enq_bits;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
    if (_widx_T_1 & index == 5'h11)	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16, :85:64, :86:{22,35}, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      mem_17 <= io_enq_bits;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
    if (_widx_T_1 & index == 5'h12)	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16, :85:64, :86:{22,35}, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      mem_18 <= io_enq_bits;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
    if (_widx_T_1 & index == 5'h13)	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16, :85:64, :86:{22,35}, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      mem_19 <= io_enq_bits;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
    if (_widx_T_1 & index == 5'h14)	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16, :85:64, :86:{22,35}, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      mem_20 <= io_enq_bits;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
    if (_widx_T_1 & index == 5'h15)	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16, :85:64, :86:{22,35}, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      mem_21 <= io_enq_bits;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
    if (_widx_T_1 & index == 5'h16)	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16, :85:64, :86:{22,35}, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      mem_22 <= io_enq_bits;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
    if (_widx_T_1 & index == 5'h17)	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16, :85:64, :86:{22,35}, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      mem_23 <= io_enq_bits;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
    if (_widx_T_1 & index == 5'h18)	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16, :85:64, :86:{22,35}, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      mem_24 <= io_enq_bits;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
    if (_widx_T_1 & index == 5'h19)	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16, :85:64, :86:{22,35}, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      mem_25 <= io_enq_bits;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
    if (_widx_T_1 & index == 5'h1A)	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16, :85:64, :86:{22,35}, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      mem_26 <= io_enq_bits;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
    if (_widx_T_1 & index == 5'h1B)	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16, :85:64, :86:{22,35}, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      mem_27 <= io_enq_bits;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
    if (_widx_T_1 & index == 5'h1C)	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16, :85:64, :86:{22,35}, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      mem_28 <= io_enq_bits;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
    if (_widx_T_1 & index == 5'h1D)	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16, :85:64, :86:{22,35}, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      mem_29 <= io_enq_bits;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
    if (_widx_T_1 & index == 5'h1E)	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16, :85:64, :86:{22,35}, src/main/scala/chisel3/util/Decoupled.scala:52:35]
  ...
  wire [5:0]  _widx_incremented_T = widx_widx_bin + {5'h0, _widx_T_1};	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:52:25, :53:43, src/main/scala/chisel3/util/Decoupled.scala:52:35]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        mem_0 = _RANDOM[4'h0][11:0];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_1 = _RANDOM[4'h0][23:12];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_2 = {_RANDOM[4'h0][31:24], _RANDOM[4'h1][3:0]};	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_3 = _RANDOM[4'h1][15:4];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_4 = _RANDOM[4'h1][27:16];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_5 = {_RANDOM[4'h1][31:28], _RANDOM[4'h2][7:0]};	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_6 = _RANDOM[4'h2][19:8];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_7 = _RANDOM[4'h2][31:20];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_8 = _RANDOM[4'h3][11:0];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_9 = _RANDOM[4'h3][23:12];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_10 = {_RANDOM[4'h3][31:24], _RANDOM[4'h4][3:0]};	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_11 = _RANDOM[4'h4][15:4];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_12 = _RANDOM[4'h4][27:16];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_13 = {_RANDOM[4'h4][31:28], _RANDOM[4'h5][7:0]};	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_14 = _RANDOM[4'h5][19:8];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_15 = _RANDOM[4'h5][31:20];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_16 = _RANDOM[4'h6][11:0];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_17 = _RANDOM[4'h6][23:12];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_18 = {_RANDOM[4'h6][31:24], _RANDOM[4'h7][3:0]};	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_19 = _RANDOM[4'h7][15:4];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_20 = _RANDOM[4'h7][27:16];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_21 = {_RANDOM[4'h7][31:28], _RANDOM[4'h8][7:0]};	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_22 = _RANDOM[4'h8][19:8];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_23 = _RANDOM[4'h8][31:20];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_24 = _RANDOM[4'h9][11:0];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_25 = _RANDOM[4'h9][23:12];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_26 = {_RANDOM[4'h9][31:24], _RANDOM[4'hA][3:0]};	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_27 = _RANDOM[4'hA][15:4];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_28 = _RANDOM[4'hA][27:16];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_29 = {_RANDOM[4'hA][31:28], _RANDOM[4'hB][7:0]};	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_30 = _RANDOM[4'hB][19:8];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        mem_31 = _RANDOM[4'hB][31:20];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16]
        widx_widx_bin = _RANDOM[4'hC][5:0];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:52:25]
        ready_reg = _RANDOM[4'hC][6];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:52:25, :88:56]
        widx_gray = _RANDOM[4'hC][12:7];	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:52:25, :91:55]
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        widx_widx_bin = 6'h0;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:52:25, :53:23]
        ready_reg = 1'h0;	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:80:16, :88:56]
