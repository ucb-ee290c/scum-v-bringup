...
module AsyncQueueSink_31(
  ...
  output [1:0] io_deq_bits,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:135:14]
  input  [1:0] io_async_mem_0,	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:135:14]
  ...
  wire [7:0][1:0] _GEN = {{io_async_mem_7}, {io_async_mem_6}, {io_async_mem_5}, {io_async_mem_4}, {io_async_mem_3}, {io_async_mem_2}, {io_async_mem_1}, {io_async_mem_0}};	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:209:18]
  ...
  ClockCrossingReg_w2 io_deq_bits_deq_bits_reg (	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:207:25]
    .clock (clock),
