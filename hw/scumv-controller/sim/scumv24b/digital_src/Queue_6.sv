...
module Queue_6(
  ...
  wire [52:0] _ram_ext_R0_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  ram_2x53 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  assign io_deq_bits_source = _ram_ext_R0_data[16:8];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_sink = _ram_ext_R0_data[18:17];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_denied = _ram_ext_R0_data[19];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_data = _ram_ext_R0_data[51:20];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[52];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
endmodule
