...
module Queue_19(
  ...
  wire [46:0] _ram_ext_R0_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  ram_2x47 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
    ...
    .W0_clk  (clock),
    .W0_data ({5'hF, io_enq_bits_address, 5'h6, io_enq_bits_param, 3'h6})	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95]
  );
  ...
  assign io_deq_bits_corrupt = _ram_ext_R0_data[46];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
endmodule
