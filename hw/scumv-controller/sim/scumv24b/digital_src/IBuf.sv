...
module IBuf(
  ...
  input  [31:0] io_imem_bits_pc,	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:22:14]
                io_imem_bits_data,	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:22:14]
  ...
  reg  [31:0]  buf_pc;	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:35:16]
  ...
  wire [31:0]  io_inst_0_bits_raw_0 = _icData_T_4[95:64] & _icMask_T_2[31:0] | buf_data & ~(_icMask_T_2[31:0]);	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:35:16, :71:{51,92}, :72:{21,30,41,43}, :121:10, generators/rocket-chip/src/main/scala/util/package.scala:155:13]
  ...
  always @(posedge clock) begin
    ...
    if (io_inst_0_ready & _GEN_1) begin	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:35:16, :47:29, :54:{68,94}, :57:13]
      buf_pc <= io_imem_bits_pc & 32'hFFFFFFFC | io_imem_bits_pc + {29'h0, _nICReady_T, 1'h0} & 32'h3;	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:34:47, :35:16, :42:25, :59:{35,37,49,68,109}]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        buf_pc = {_RANDOM[2'h1][31:17], _RANDOM[2'h2][16:0]};	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:35:16]
        buf_data = {_RANDOM[2'h2][31:17], _RANDOM[2'h3][16:0]};	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:35:16]
        buf_xcpt_pf_inst = _RANDOM[2'h3][19];	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:35:16]
        buf_xcpt_gf_inst = _RANDOM[2'h3][20];	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:35:16]
        buf_xcpt_ae_inst = _RANDOM[2'h3][21];	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:35:16]
        buf_replay = _RANDOM[2'h3][22];	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:35:16]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  RVCExpander exp (	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:86:21]
    .io_in       (io_inst_0_bits_raw_0),	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:72:30]
  ...
  assign io_inst_0_bits_raw = io_inst_0_bits_raw_0;	// @[generators/rocket-chip/src/main/scala/rocket/IBuf.scala:72:30]
endmodule
