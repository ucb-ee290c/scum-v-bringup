...
module Queue_18(
  ...
  input  [1:0]  io_enq_bits_source,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
                io_enq_bits_sink,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  output [1:0]  io_deq_bits_source,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
                io_deq_bits_sink,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  wire [45:0] _ram_ext_R0_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  ram_2x46 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  assign io_deq_bits_source = _ram_ext_R0_data[9:8];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_sink = _ram_ext_R0_data[11:10];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_denied = _ram_ext_R0_data[12];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_data = _ram_ext_R0_data[44:13];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[45];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
endmodule
