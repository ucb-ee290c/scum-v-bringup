...
module DSPClockDomainWrapper(
  ...
  output [23:0] io_adc_data_out_bits,	// @[generators/scumv-sensor-adc/src/main/scala/sensoradc/DSPClockDomainWrapper.scala:8:14]
  ...
  wire [58:0] _cic_decim_io_output_bits;	// @[generators/scumv-sensor-adc/src/main/scala/sensoradc/DSPClockDomainWrapper.scala:135:25]
  ...
  wire        io_chopper_clock_1_0 = ~(chopper_clk_en_buf[0]) | _firstStageGen_io_clock_gen;	// @[generators/scumv-sensor-adc/src/main/scala/sensoradc/DSPClockDomainWrapper.scala:55:35, :62:29, :70:{28,47}]
  reg  [24:0] secondStageDivider;	// @[generators/scumv-sensor-adc/src/main/scala/sensoradc/DSPClockDomainWrapper.scala:78:35]
  wire        io_chopper_clock_2_0 = ~(chopper_clk_en_buf[1]) | _secondStageGen_io_clock_gen;	// @[generators/scumv-sensor-adc/src/main/scala/sensoradc/DSPClockDomainWrapper.scala:55:35, :76:30, :84:{28,47}]
  ...
  reg  [58:0] cic_decim_output_bits;	// @[generators/scumv-sensor-adc/src/main/scala/sensoradc/DSPClockDomainWrapper.scala:141:48]
  always @(posedge clock) begin
    if (reset) begin
      pMux <= 4'h2;	// @[generators/scumv-sensor-adc/src/main/scala/sensoradc/DSPClockDomainWrapper.scala:29:21]
      nMux <= 4'h1;	// @[generators/scumv-sensor-adc/src/main/scala/sensoradc/DSPClockDomainWrapper.scala:30:21]
      ...
      if (rCtr == 13'h1F3F) begin	// @[generators/scumv-sensor-adc/src/main/scala/sensoradc/DSPClockDomainWrapper.scala:31:21, :32:14]
        pMux <= pMux == 4'h8 ? 4'h1 : {pMux[2:0], 1'h0};	// @[generators/scumv-sensor-adc/src/main/scala/sensoradc/DSPClockDomainWrapper.scala:29:21, :30:21, :34:{16,22,41}]
        nMux <= nMux == 4'h8 ? 4'h1 : {nMux[2:0], 1'h0};	// @[generators/scumv-sensor-adc/src/main/scala/sensoradc/DSPClockDomainWrapper.scala:30:21, :34:{22,41}, :35:{16,22,41}]
        rCtr <= 13'h0;	// @[generators/scumv-sensor-adc/src/main/scala/sensoradc/DSPClockDomainWrapper.scala:31:21]
      end
      else	// @[generators/scumv-sensor-adc/src/main/scala/sensoradc/DSPClockDomainWrapper.scala:32:14]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        cic_decim_output_bits = {_RANDOM[3'h3][31:10], _RANDOM[3'h4], _RANDOM[3'h5][4:0]};	// @[generators/scumv-sensor-adc/src/main/scala/sensoradc/DSPClockDomainWrapper.scala:101:36, :141:48]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Dechopper dechopper (	// @[generators/scumv-sensor-adc/src/main/scala/sensoradc/DSPClockDomainWrapper.scala:125:25]
    ...
    .io_chopper_clock       (dsp_control_buf[1] ? io_chopper_clock_2_0 : io_chopper_clock_1_0),	// @[generators/scumv-sensor-adc/src/main/scala/sensoradc/DSPClockDomainWrapper.scala:43:32, :48:41, :70:28, :84:28, :127:36]
  ...
  SensorOutFSM sensorOutFSM (	// @[generators/scumv-sensor-adc/src/main/scala/sensoradc/DSPClockDomainWrapper.scala:150:28]
    ...
    .io_adc_data_out_bits  (cic_decim_output_bits[57:34]),	// @[generators/scumv-sensor-adc/src/main/scala/sensoradc/DSPClockDomainWrapper.scala:141:48, :147:{24,48}]
  ...
  assign io_adc_data_out_bits = cic_decim_output_bits[57:34];	// @[generators/scumv-sensor-adc/src/main/scala/sensoradc/DSPClockDomainWrapper.scala:141:48, :147:{24,48}]
  assign io_chopper_clock_1 = io_chopper_clock_1_0;	// @[generators/scumv-sensor-adc/src/main/scala/sensoradc/DSPClockDomainWrapper.scala:70:28]
  assign io_chopper_clock_2 = io_chopper_clock_2_0;	// @[generators/scumv-sensor-adc/src/main/scala/sensoradc/DSPClockDomainWrapper.scala:84:28]
