...
module Repeater_15(
  ...
  input  [11:0] io_enq_bits_source,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:12:14]
  input  [31:0] io_enq_bits_address,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:12:14]
  input  [3:0]  io_enq_bits_mask,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:12:14]
  input         io_deq_ready,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:12:14]
  ...
  output [11:0] io_deq_bits_source,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:12:14]
  output [31:0] io_deq_bits_address,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:12:14]
  output [3:0]  io_deq_bits_mask	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:12:14]
);
  ...
  reg  [11:0] saved_source;	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:20:18]
  reg  [31:0] saved_address;	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:20:18]
  reg  [3:0]  saved_mask;	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:20:18]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        saved_source = _RANDOM[1'h0][21:10];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:19:21, :20:18]
        saved_address = {_RANDOM[1'h0][31:22], _RANDOM[1'h1][21:0]};	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:19:21, :20:18]
        saved_mask = _RANDOM[1'h1][25:22];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:20:18]
      `endif // RANDOMIZE_REG_INIT
    end // initial
