...
module Queue_28(
  ...
  input  [31:0] io_enq_bits_addr,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
                io_enq_bits_data,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  input  [2:0]  io_enq_bits_totalBytes,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  output [31:0] io_deq_bits_addr,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
                io_deq_bits_data,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  output [2:0]  io_deq_bits_totalBytes	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
);

  wire [66:0] _ram_ext_R0_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  ram_2x67 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_totalBytes, io_enq_bits_data, io_enq_bits_addr})	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  );
  ...
  assign io_deq_bits_addr = _ram_ext_R0_data[31:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_data = _ram_ext_R0_data[63:32];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_totalBytes = _ram_ext_R0_data[66:64];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
endmodule
