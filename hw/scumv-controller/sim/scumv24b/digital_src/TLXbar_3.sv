...
module TLXbar_3(
  ...
  input         auto_in_1_d_ready,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
  ...
  input  [7:0]  auto_in_0_a_bits_source,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
  ...
  output [7:0]  auto_in_0_d_bits_source,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
  ...
  output [8:0]  auto_out_a_bits_source,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
  ...
  input  [8:0]  auto_out_d_bits_source,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
  ...
  wire        requestDOI_0_1 = auto_out_d_bits_source[8:2] == 7'h40;	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:54:{10,32}]
  wire        portsDIO_filtered_0_valid = auto_out_d_valid & ~(auto_out_d_bits_source[8]);	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:54:{10,32}, generators/rocket-chip/src/main/scala/tilelink/Xbar.scala:351:40]
  wire        portsDIO_filtered_1_valid = auto_out_d_valid & requestDOI_0_1;	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:54:32, generators/rocket-chip/src/main/scala/tilelink/Xbar.scala:351:40]
  ...
  TLMonitor_21 monitor (	// @[generators/rocket-chip/src/main/scala/tilelink/Nodes.scala:24:25]
    .clock                (clock),
    .reset                (reset),
    ...
    .io_in_d_bits_source  (auto_out_d_bits_source[7:0]),	// @[generators/rocket-chip/src/main/scala/tilelink/Xbar.scala:152:69]
    .io_in_d_bits_sink    (auto_out_d_bits_sink),
    .io_in_d_bits_denied  (auto_out_d_bits_denied),
    .io_in_d_bits_corrupt (auto_out_d_bits_corrupt)
  );
  TLMonitor_22 monitor_1 (	// @[generators/rocket-chip/src/main/scala/tilelink/Nodes.scala:24:25]
    .clock                (clock),
    .reset                (reset),
    ...
    .io_in_d_bits_param   (auto_out_d_bits_param),
    .io_in_d_bits_size    (auto_out_d_bits_size),
    .io_in_d_bits_source  (auto_out_d_bits_source[1:0]),	// @[generators/rocket-chip/src/main/scala/tilelink/Xbar.scala:152:69]
    .io_in_d_bits_sink    (auto_out_d_bits_sink),
    .io_in_d_bits_denied  (auto_out_d_bits_denied),
    .io_in_d_bits_corrupt (auto_out_d_bits_corrupt)
  );
  ...
  assign auto_in_1_d_bits_source = auto_out_d_bits_source[1:0];	// @[generators/rocket-chip/src/main/scala/tilelink/Xbar.scala:152:69]
  ...
  assign auto_in_0_d_bits_source = auto_out_d_bits_source[7:0];	// @[generators/rocket-chip/src/main/scala/tilelink/Xbar.scala:152:69]
  ...
  assign auto_out_a_bits_opcode = (muxState_0 ? auto_in_0_a_bits_opcode : 3'h0) | (muxState_1 ? auto_in_1_a_bits_opcode : 3'h0);	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18, generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:89:25, generators/rocket-chip/src/main/scala/tilelink/Nodes.scala:24:25, src/main/scala/chisel3/util/Mux.scala:30:73]
  ...
  assign auto_out_a_bits_size = (muxState_0 ? auto_in_0_a_bits_size : 3'h0) | (muxState_1 ? auto_in_1_a_bits_size : 3'h0);	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18, generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:89:25, generators/rocket-chip/src/main/scala/tilelink/Nodes.scala:24:25, src/main/scala/chisel3/util/Mux.scala:30:73]
  assign auto_out_a_bits_source = (muxState_0 ? {1'h0, auto_in_0_a_bits_source} : 9'h0) | (muxState_1 ? {7'h40, auto_in_1_a_bits_source} : 9'h0);	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:54:32, generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:89:25, generators/rocket-chip/src/main/scala/tilelink/Bundles.scala:259:74, generators/rocket-chip/src/main/scala/tilelink/Xbar.scala:162:{29,55}, src/main/scala/chisel3/util/Mux.scala:30:73]
  ...
  assign auto_out_a_bits_mask = (muxState_0 ? auto_in_0_a_bits_mask : 4'h0) | (muxState_1 ? auto_in_1_a_bits_mask : 4'h0);	// @[generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:89:25, generators/rocket-chip/src/main/scala/tilelink/Bundles.scala:259:74, src/main/scala/chisel3/util/Mux.scala:30:73]
  ...
  assign auto_out_d_ready = ~(auto_out_d_bits_source[8]) & auto_in_0_d_ready | requestDOI_0_1 & auto_in_1_d_ready;	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:54:{10,32}, src/main/scala/chisel3/util/Mux.scala:30:73]
endmodule
