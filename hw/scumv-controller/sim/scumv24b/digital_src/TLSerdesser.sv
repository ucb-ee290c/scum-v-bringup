...
module TLSerdesser(
  input         clock,
                reset,
                auto_client_out_a_ready,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
  output        auto_client_out_a_valid,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
  output [2:0]  auto_client_out_a_bits_opcode,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
                auto_client_out_a_bits_param,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
                auto_client_out_a_bits_size,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
  output [7:0]  auto_client_out_a_bits_source,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
  output [31:0] auto_client_out_a_bits_address,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
  output [3:0]  auto_client_out_a_bits_mask,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
  output [31:0] auto_client_out_a_bits_data,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
  output        auto_client_out_a_bits_corrupt,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
                auto_client_out_d_ready,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
  input         auto_client_out_d_valid,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
  input  [2:0]  auto_client_out_d_bits_opcode,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
  input  [1:0]  auto_client_out_d_bits_param,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
  input  [2:0]  auto_client_out_d_bits_size,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
  input  [7:0]  auto_client_out_d_bits_source,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
  input  [1:0]  auto_client_out_d_bits_sink,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
  input         auto_client_out_d_bits_denied,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
  input  [31:0] auto_client_out_d_bits_data,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
  input         auto_client_out_d_bits_corrupt,	// @[generators/rocket-chip/src/main/scala/diplomacy/LazyModule.scala:366:18]
  ...
  wire [3:0]  merged_bits_last_beats1 = auto_client_out_d_bits_opcode[0] ? ~(_merged_bits_last_beats1_decode_T_1[5:2]) : 4'h0;	// @[generators/rocket-chip/src/main/scala/tilelink/Bundles.scala:259:74, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:106:36, :221:14, generators/rocket-chip/src/main/scala/util/package.scala:235:{46,71,76}]
  reg  [3:0]  merged_bits_last_counter_1;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
  always @(posedge clock) begin
    if (reset)
      merged_bits_last_counter_1 <= 4'h0;	// @[generators/rocket-chip/src/main/scala/tilelink/Bundles.scala:259:74, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
      ...
      if (merged_bits_last_counter_1 == 4'h0)	// @[generators/rocket-chip/src/main/scala/tilelink/Bundles.scala:259:74, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27, :231:25]
        merged_bits_last_counter_1 <= merged_bits_last_beats1;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:221:14, :229:27]
      else	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:231:25]
        merged_bits_last_counter_1 <= merged_bits_last_counter_1 - 4'h1;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27, :230:28]
    end
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        merged_bits_last_counter_1 = _RANDOM[/*Zero width*/ 1'b0][7:4];	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  HellaPeekingArbiter outArb (	// @[generators/testchipip/src/main/scala/serdes/TLSerdes.scala:432:24]
    ...
    .io_in_1_bits_size    ({5'h0, auto_client_out_d_bits_size}),	// @[generators/testchipip/src/main/scala/serdes/TLSerdes.scala:106:20]
    .io_in_1_bits_source  (auto_client_out_d_bits_source),
    .io_in_1_bits_data    ({32'h0, auto_client_out_d_bits_data}),	// @[generators/testchipip/src/main/scala/serdes/TLSerdes.scala:109:20]
    .io_in_1_bits_corrupt (auto_client_out_d_bits_corrupt),
    .io_in_1_bits_union   ({6'h0, auto_client_out_d_bits_sink, auto_client_out_d_bits_denied}),	// @[generators/testchipip/src/main/scala/serdes/TLSerdes.scala:112:22]
    .io_in_1_bits_last    (merged_bits_last_counter_1 == 4'h1 | merged_bits_last_beats1 == 4'h0),	// @[generators/rocket-chip/src/main/scala/tilelink/Bundles.scala:259:74, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:221:14, :229:27, :232:{25,33,43}]
    ...
    .io_in_4_bits_union   (9'h0),	// @[generators/testchipip/src/main/scala/serdes/TLSerdes.scala:91:22]
  ...
  GenericDeserializer inDes (	// @[generators/testchipip/src/main/scala/serdes/TLSerdes.scala:440:23]
    ...
    .io_out_ready        (~(_inDes_io_out_bits_chanId == 3'h4 | _inDes_io_out_bits_chanId == 3'h3 | _inDes_io_out_bits_chanId == 3'h2 | _inDes_io_out_bits_chanId == 3'h1) & ~(|_inDes_io_out_bits_chanId) & auto_client_out_a_ready),	// @[generators/testchipip/src/main/scala/serdes/TLSerdes.scala:27:37, :124:20, :440:23, :453:71]
  ...
  assign auto_client_out_a_bits_size = _inDes_io_out_bits_size[2:0];	// @[generators/testchipip/src/main/scala/serdes/TLSerdes.scala:165:15, :440:23]
  ...
  assign auto_client_out_a_bits_mask = _inDes_io_out_bits_union[3:0];	// @[generators/testchipip/src/main/scala/serdes/TLSerdes.scala:173:15, :440:23]
  assign auto_client_out_a_bits_data = _inDes_io_out_bits_data[31:0];	// @[generators/testchipip/src/main/scala/serdes/TLSerdes.scala:168:15, :440:23]
