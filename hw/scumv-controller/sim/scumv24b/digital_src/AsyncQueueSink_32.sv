...
module AsyncQueueSink_32(
  ...
  wire [3:0]      _ridx_incremented_T = ridx_ridx_bin + {3'h0, io_deq_valid_0};	// @[generators/rocket-chip/src/main/scala/util/AsyncQueue.scala:52:25, :53:43, :162:29]
  ...
  wire [7:0][7:0] _GEN = {{io_async_mem_7}, {io_async_mem_6}, {io_async_mem_5}, {io_async_mem_4}, {io_async_mem_3}, {io_async_mem_2}, {io_async_mem_1}, {io_async_mem_0}};	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:209:18]
