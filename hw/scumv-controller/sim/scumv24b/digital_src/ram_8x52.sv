...
module ram_8x52(	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  input  [2:0]  R0_addr,
  input         R0_en,
                R0_clk,
  output [51:0] R0_data,
  ...
  reg [51:0] Memory[0:7];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
    ...
    initial begin	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
        for (logic [3:0] i = 4'h0; i < 4'h8; i += 4'h1) begin
          ...
          Memory[i[2:0]] = _RANDOM_MEM[51:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
        end	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // ENABLE_INITIAL_MEM_
  assign R0_data = R0_en ? Memory[R0_addr] : 52'bx;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
endmodule
