...
module Repeater_4(
  ...
  input  [10:0] io_enq_bits_source,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:12:14]
  input  [29:0] io_enq_bits_address,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:12:14]
  input         io_enq_bits_mask,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:12:14]
                io_enq_bits_corrupt,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:12:14]
  ...
  output [10:0] io_deq_bits_source,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:12:14]
  output [29:0] io_deq_bits_address,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:12:14]
  output        io_deq_bits_mask,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:12:14]
                io_deq_bits_corrupt	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:12:14]
);
  ...
  reg  [10:0] saved_source;	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:20:18]
  reg  [29:0] saved_address;	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:20:18]
  reg         saved_mask;	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:20:18]
  reg         saved_corrupt;	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:20:18]
  wire        io_deq_valid_0 = io_enq_valid | full;	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:19:21, :23:32]
  wire        io_enq_ready_0 = io_deq_ready & ~full;	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:19:21, :24:{32,35}]
  wire        _GEN = io_enq_ready_0 & io_enq_valid & io_repeat;	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:24:32, :28:21]
  always @(posedge clock) begin
    if (reset)
      full <= 1'h0;	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:19:21]
    else
      full <= ~(io_deq_ready & io_deq_valid_0 & ~io_repeat) & (_GEN | full);	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:19:21, :23:32, :28:{21,36,43}, :29:{21,24,36,43}]
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        full = _RANDOM[1'h0][0];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:19:21]
        saved_opcode = _RANDOM[1'h0][3:1];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:19:21, :20:18]
        saved_param = _RANDOM[1'h0][6:4];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:19:21, :20:18]
        saved_size = _RANDOM[1'h0][9:7];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:19:21, :20:18]
        saved_source = _RANDOM[1'h0][20:10];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:19:21, :20:18]
        saved_address = {_RANDOM[1'h0][31:21], _RANDOM[1'h1][18:0]};	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:19:21, :20:18]
        saved_mask = _RANDOM[1'h1][19];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:20:18]
        saved_corrupt = _RANDOM[1'h1][28];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:20:18]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_enq_ready = io_enq_ready_0;	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:24:32]
  assign io_deq_valid = io_deq_valid_0;	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:23:32]
