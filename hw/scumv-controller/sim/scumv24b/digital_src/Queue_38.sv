...
module Queue_38(
  ...
  input         io_enq_bits_source,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  input  [1:0]  io_enq_bits_sink,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  output        io_deq_bits_source,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  output [1:0]  io_deq_bits_sink,	// @[src/main/scala/chisel3/util/Decoupled.scala:273:14]
  ...
  wire [44:0] _ram_ext_R0_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  ram_2x45 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  ...
  assign io_deq_bits_size = _ram_ext_R0_data[7:5];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_source = _ram_ext_R0_data[8];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_sink = _ram_ext_R0_data[10:9];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_denied = _ram_ext_R0_data[11];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_data = _ram_ext_R0_data[43:12];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[44];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
endmodule
